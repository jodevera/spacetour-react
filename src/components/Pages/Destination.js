...
const Destination = () => {
    const destObj = [
        ...
        { id: 'mars', title: 'MARS', image: marsImg, desc: 'Don’t forget to pack your hiking boots. You’ll need them to tackle Olympus Mons, the tallest planetary mountain in our solar system. It’s two and a half times the size of Everest!', avgTime: '225 MIL. KM', eTT: '9 MONTHS' },
        { id: 'europa', title: 'EUROPA', image: europaImg, desc: 'The smallest of the four Galilean moons orbiting Jupiter, Europa is a winter lover’s dream. With an icy surface, it’s perfect for a bit of ice skating, curling, hockey, or simple relaxation in your snug wintery cabin.', avgTime: '628 MIL. KM', eTT: '3 YEARS' }, 
        { id: 'titan', title: 'TITAN', image: titanImg, desc: 'The only moon known to have a dense atmosphere other than Earth, Titan is a home away from home (just a few hundred degrees colder!). As a bonus, you get striking views of the Rings of Saturn.', avgTime: '1.6 BIL. KM', eTT: '7 YEARS' } 
    ]
    ...
    return (
        <>
            <div className = "subtitle heading5"><span className = "number">01</span>&nbsp;PICK YOUR DESTINATION</div>
            <div className = "destinationContainer">
                <div className = "destinationImage">
                    <img className = "destinationImgSrc" id = "destImg" src = {img} alt = "Moon" />
                </div>
                <div className  = "destinationText">
                    ...
                    <div className = 'destinationStats'>
                        <div className = "destinationAvgDist">
                            <span className = "destinationLabel subheading2">AVG. DISTANCE</span>
                            <span id = "destAve" className = "destinationVal subheading1">{avg}</span>
                        </div>
                        <div className = "destinationETT">
                            <span className = "destinationLabel subheading2">EST. TRAVEL TIME</span>
                            <span id ="destTravel" className = "destinationVal subheading1">{ett}</span>
                        </div>
                    </div>
                </div>  
            </div>
